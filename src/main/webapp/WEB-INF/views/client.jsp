...
<head>
  ...
  <title>RentalCar | Clientes</title>
          ...
          <table class="table table-striped table-sm">
            ...
            <c:forEach var="client" items="${clientsList}" >
              <tr>
                ...
                <td><c:out value="${client.address.street}, ${client.address.number_address}, ${client.address.complement}" /></td>
                <td><c:out value="${client.address.cep}" /></td>
                <td><c:out value="${client.address.city} - ${client.address.state}" /></td>
                <td><c:out value="(${client.phones[0].ddd}) ${client.phones[0].number}" /></td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
